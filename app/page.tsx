  ...
  return (
    <div className="page-overlay flex flex-col bg-[#d6cdc2] font-sans h-svh">
      ...
      <main className="flex flex-col items-center justify-center h-svh">
        ...
        <div className="flex flex-col items-center gap-5 sm:gap-7 z-20 mx-10">
          ...
          <div className="font-medium font-mono sm:mb-22">
            <a
              className="flex h-12 w-full mt-5 items-center rounded-full bg-[#7d7f48] px-5 text-foreground transition-colors hover:bg-[#55572c] "
